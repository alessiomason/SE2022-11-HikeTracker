            ...
            <Row>
              ...
              <Col md={4}>
                <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                  ...
                  <Form.Control required={true} value={description} onChange={ev => setDescription(ev.target.value)} as="textarea" rows={2} />
                </Form.Group>
              </Col>
              <Col md={4} className="box_btn">
                <Button variant="primary" className="btn_box mx-2" >Add a reference point </Button>
